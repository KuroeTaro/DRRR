...
function drawSecondGlowInCharSelect(glowAlphaPoint,image,object)
    ...
    love.graphics.setColor(1, 1, 1, object[4][1])
    love.graphics.draw(image[0],object[1],object[2],0,object[3],object[3])
    love.graphics.setColor(1, 1, 1, object[4][2])
    love.graphics.draw(image[1],object[1],object[2],0,object[3],object[3])
    love.graphics.setColor(1, 1, 1, object[4][3])
    love.graphics.draw(image[2],object[1],object[2],0,object[3],object[3])
    love.graphics.setColor(1, 1, 1, 1)
    love.graphics.setCanvas()
