...
function drawSecondGlowInCharSelect(glowAlphaPoint,image,object)
    local x = resolutionCorrection(object[1])
    local y = resolutionCorrection(object[2])
    local s = resolutionCorrection(object[3])
    ...
    love.graphics.setColor(1, 1, 1, object[4][object["layer"][3]+1])
    love.graphics.draw(image[object["layer"][3]],object[1],object[2],0,object[3],object[3])
    love.graphics.setColor(1, 1, 1, object[4][object["layer"][2]+1])
    love.graphics.draw(image[object["layer"][2]],object[1],object[2],0,object[3],object[3])
    love.graphics.setColor(1, 1, 1, object[4][object["layer"][1]+1])
    love.graphics.draw(image[object["layer"][1]],object[1],object[2],0,object[3],object[3])
    love.graphics.setColor(1, 1, 1, 1)
    love.graphics.setCanvas()

    love.graphics.setCanvas(canvasAlphaCom)
    love.graphics.setColor(1, 1, 1, object[4][4])
